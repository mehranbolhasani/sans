...
export function SearchInput() {
  ...
  return (
    <input
      ...
      placeholder="Search..."
      className="w-full border-b border-border bg-transparent px-4 py-2 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-foreground/30"
    />
  );
}
